...
export const DEFAULT_SHORTCUTS: ShortcutBinding[] = [
  ...
  { keyLabel: '1', key: '1', commandName: 'ui.toggleLeftDrawer', description: 'Toggle drawer 1 (Objects + Inspector)' },
  { keyLabel: 'Ctrl+1', key: '1', ctrlOrMeta: true, commandName: 'ui.toggleLeftDrawer', commandParams: { docked: true }, description: 'Dock drawer 1' },
  { keyLabel: '2', key: '2', commandName: 'ui.toggleParamPanel', description: 'Toggle drawer 2 (Card View)' },
  { keyLabel: 'Ctrl+2', key: '2', ctrlOrMeta: true, commandName: 'ui.toggleParamPanel', commandParams: { docked: true }, description: 'Dock drawer 2' },
  { keyLabel: '3', key: '3', commandName: 'ui.toggleScriptPanel', description: 'Toggle drawer 3 (Scripting)' },
  { keyLabel: 'Ctrl+3', key: '3', ctrlOrMeta: true, commandName: 'ui.toggleScriptPanel', commandParams: { docked: true }, description: 'Dock drawer 3' },
  { keyLabel: '4', key: '4', commandName: 'ui.toggleMetrics', description: 'Toggle drawer 4 (Metrics)' },
  { keyLabel: 'Ctrl+4', key: '4', ctrlOrMeta: true, commandName: 'ui.toggleMetrics', commandParams: { docked: true }, description: 'Dock drawer 4' },
  ...
  { keyLabel: 'V', key: 'v', commandName: 'brush.cycleNext', description: 'Next brush' },
  { keyLabel: 'M', key: 'm', commandName: 'brush.cycleBlendMode', description: 'Cycle blend mode' },
  { keyLabel: '[', key: '[', commandName: 'brush.radiusDown', description: 'Decrease brush radius' },
  { keyLabel: ']', key: ']', commandName: 'brush.radiusUp', description: 'Increase brush radius' },
