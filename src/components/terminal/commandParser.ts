...
const PARAM_MAPPINGS: Record<string, string[]> = {
  ...
  'op.list': [],
  'op.show': ['id'],
  'op.setPhase': ['id', 'phase'],
  'op.copy': ['id', 'ownerType', '?ownerId'],
  'op.enable': ['id'],
  'op.disable': ['id'],
  'op.add': ['source', '?property', '?...code'],
  'op.remove': ['id'],
  'op.edit': ['id', '?...code'],
  'tag.list': [],
  'tag.show': ['id'],
...
const ARG_HINTS: Record<string, string> = {
  ...
  'op.list': '',
  'op.show': '<id>',
  'op.setPhase': '<id> <pre-rule|post-rule>',
  'op.copy': '<id> <ownerType> [ownerId]',
  'op.enable': '<id>',
  'op.disable': '<id>',
  'op.add': '<code|link|script> [property] [code]',
  'op.remove': '<id>',
  'op.edit': '<id> [code]',
  'tag.list': '',
  'tag.show': '<id>',
